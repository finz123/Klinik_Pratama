        ...
        <Box sx={{ display: 'flex', flexDirection: 'row', gap: 1, width: '50%', justifyContent: 'center' }}>
          ...
          <Link href="/validasi?poliklinik=PoliKlinik Umum" passHref>
            <Button
              ...
              sx={{ ...buttonStyles, width: '450px', height: '70px', marginTop: 0.2, fontSize: '24px', }}
            >
              Poliklinik Umum
            </Button>
            </Link>
            ...
            <Link href="/validasi?poliklinik=Poliklinik Laboratorium" passHref>            <Button
              variant="outlined"
            ...
            <Link href="/validasi?poliklinik=Poli KB" passHref>            <Button
              variant="outlined"
            ...
            <Link href="/validasi?poliklinik=Poli Persalinan" passHref>            <Button
              variant="outlined"
            ...
            <Link href="/validasi?poliklinik=Poli TB & Paru" passHref>            <Button
              variant="outlined"
